...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  return (
    <div className="flex items-center gap-2 mt-2 w-full max-w-md max-sm:flex-col max-sm:items-stretch max-lg:text-gray-900 max-lg:dark:text-gray-900">
      <input
        type="text"
        className="input input-bordered grow bg-white text-gray-900 placeholder:text-gray-500 max-lg:dark:bg-white max-lg:dark:text-gray-900 max-lg:dark:placeholder:text-gray-500 max-sm:w-full"
