...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col p-4 mt-10 max-lg:bg-white max-lg:text-gray-900 max-lg:dark:bg-white max-lg:dark:text-gray-900">
      {/* Header Section */}
      ...
      {auth.isSurgeon && (
        <span className="font-bold text-lg max-lg:text-gray-900 max-lg:dark:text-gray-900">
          Surgeon ID: {auth.user?.id}
        </span>
      )}

      {/* Content Section */}
      <div className="flex flex-col w-full gap-4 max-lg:text-gray-900 max-lg:dark:text-gray-900">
        {!addNew ? (
