...
export const Questions: QuestionType[] = [
  ...
  */  
  { id: 9, code: "OKS1", question: "How would you describe the pain you usually have from your knee?", list: OKSKneePain, description: "Usual knee pain", chQuestion: "您如何描述膝盖通常的疼痛?", chineseDescription: "膝盖通常的疼痛", chList: OKSKneePainCh },
  { id: 10, code: "OKS2", question: "Have you had any trouble with washing and drying yourself (all over) because of your knee?", list: OKSKneeTrouble, description: "Trouble with washing and drying self (all over) because of knee" , chQuestion: "您是否因为膝盖问题在洗澡或擦干身体时感到困难？", chineseDescription: "膝盖造成的洗澡和擦干身体困难", chList: chOKSWashingTrouble },
  { id: 11, code: "OKS3", question: "Have you had any trouble getting in and out of a car or using public transport because of your knee? (whichever you tend to use)", list: OKSKneeTrouble, description: "Trouble getting in and out of a car or using public transport because of knee", chQuestion: "您是否因为膝盖问题在上下车或使用公共交通时感到困难？", chineseDescription: "膝盖造成的上下车或巴士困难", chList: OKSCarTroubleCh },
  { id: 12, code: "OKS4", question: "For how long have you been able to walk before pain from your knee becomes severe? (with or without a stick)", list: OKSWalking, description: "Walking duration before knee pain becomes severe", chQuestion: "您走路多久之后膝盖疼痛会变得严重（用或不用拐杖)？", chineseDescription: "走路多久之后膝盖疼痛会变得严重", chList: OKSWalkingCh },
  { id: 13, code: "OKS5", question: "After a meal (sat at a table), how painful has it been for you to stand up from a chair because of your knee?", list: OKSStanding, description: "Pain when standing up from a chair after a meal", chQuestion: "在吃完饭后（坐在餐桌旁），因为膝盖问题，您从椅子上站起来时有多痛？", chineseDescription: "饭后从椅子上站起时的疼痛", chList: OKSStandingCh },
  { id: 14, code: "OKS6", question: "Have you been limping when walking, because of your knee?", list: OKSFrequency, description: "Limping when walking because of knee", chQuestion: "您走路时是否因为膝盖问题而跛行（一瘸一拐）？", chineseDescription: "膝盖造成的跛行（一瘸一拐）", chList: OKSFrequencyCh },
  { id: 15, code: "OKS7", question: "Could you kneel down and get up again afterwards?", list: OKSEase, description: "Kneeling down and getting up again", chQuestion: "您能跪下后又站起来吗？", chineseDescription: "跪下再起身", chList: OKSKneelingCh },
  { id: 16, code: "OKS8", question: "Have you been troubled by pain from your knee in bed at night?", list: OKSNightPain, description: "Troubled by knee pain in bed at night", chQuestion: "您晚上睡觉时是否因为膝盖疼痛而感到困扰？", chineseDescription: "晚上睡觉时膝盖疼痛造成的困扰", chList: OKSNightPainCh },
  { id: 17, code: "OKS9", question: "How much has pain from your knee interfered with your usual work (including housework)?", list: OKSWorkInterference, description: "Interference of knee pain with usual work (including housework)", chQuestion: "膝盖疼痛对您的日常工作（包括家务活）有多大的影响？", chineseDescription: "膝盖疼痛对日常工作（包括家务活）的干扰", chList: OKSWorkInterferenceCh },
  { id: 18, code: "OKS10", question: "Have you felt that your knee might suddenly 'give way' or let you down?", list: OKSFrequency, description: "Feeling knee might suddenly 'giving way' or let you down", chQuestion: "您曾感到膝盖会突然“打软”或让你跌倒吗？", chineseDescription: "感觉膝盖会突然“打软”或让你跌倒", chList: GiveWayCh },
  { id: 19, code: "OKS11", question: "Could you do the household shopping on your own?", list: OKSEase, description: "Doing household shopping alone", chQuestion: "您可以自己去买东西吗？", chineseDescription: "自己一个人去买东西", chList: OKSEaseCh },
  { id: 20, code: "OKS12", question: "Could you walk down one flight of stairs?", list: OKSEase, description: "Walking down one flight of stairs", chQuestion: "您能往下走一层楼梯吗？", chineseDescription: "下一层楼梯", chList: OKSEaseCh },
];
